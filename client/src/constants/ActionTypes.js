...
export default {
  ...
  GLOBAL_CALENDAR_CARDS_FETCH: 'GLOBAL_CALENDAR_CARDS_FETCH',
  GLOBAL_CALENDAR_CARDS_FETCH__SUCCESS: 'GLOBAL_CALENDAR_CARDS_FETCH__SUCCESS',
  GLOBAL_CALENDAR_CARDS_FETCH__FAILURE: 'GLOBAL_CALENDAR_CARDS_FETCH__FAILURE',
  ...
  ARCHIVED_PROJECTS_TOGGLE: 'ARCHIVED_PROJECTS_TOGGLE',
  ...
  PROJECT_ARCHIVE__SUCCESS: 'PROJECT_ARCHIVE__SUCCESS',
  PROJECT_ARCHIVE__FAILURE: 'PROJECT_ARCHIVE__FAILURE',
  PROJECT_ARCHIVE_HANDLE: 'PROJECT_ARCHIVE_HANDLE',
  ...
  BOARD_ARCHIVE__SUCCESS: 'BOARD_ARCHIVE__SUCCESS',
  BOARD_ARCHIVE__FAILURE: 'BOARD_ARCHIVE__FAILURE',
  BOARD_ARCHIVE_HANDLE: 'BOARD_ARCHIVE_HANDLE',
  BOARD_RESTORE: 'BOARD_RESTORE',
  BOARD_RESTORE__SUCCESS: 'BOARD_RESTORE__SUCCESS',
  BOARD_RESTORE__FAILURE: 'BOARD_RESTORE__FAILURE',
  BOARD_RESTORE_HANDLE: 'BOARD_RESTORE_HANDLE',
  BOARD_DUPLICATE: 'BOARD_DUPLICATE',
  BOARD_DUPLICATE__SUCCESS: 'BOARD_DUPLICATE__SUCCESS',
  BOARD_DUPLICATE__FAILURE: 'BOARD_DUPLICATE__FAILURE',
  BOARD_CONTEXT_UPDATE: 'BOARD_CONTEXT_UPDATE',
  ARCHIVED_BOARDS_TOGGLE: 'ARCHIVED_BOARDS_TOGGLE',
  ...
  LIST_DUPLICATE__SUCCESS: 'LIST_DUPLICATE__SUCCESS',
  LIST_DUPLICATE__FAILURE: 'LIST_DUPLICATE__FAILURE',
  LIST_SORT: 'LIST_SORT',
