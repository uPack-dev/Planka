...
export default {
  ...
  translation: {
    common: {
      ...
      archive: 'Архив',
      archiveBoard_title: 'Архивировать доску',
      archiveCard_title: 'Архивировать карточку',
      archiveCards_title: 'Архивировать карточки',
      archiveProject_title: 'Архивировать проект',
      archivedBoard: 'Архивная доска',
      archivedBoards_title: 'Архивные доски',
      archivedProjects_title: 'Архивные проекты',
      areYouSureYouWantToActivateThisUser:
        'Вы уверены, что хотите активировать этого пользователя?',
      areYouSureYouWantToArchiveThisBoard: 'Вы уверены, что хотите архивировать эту доску?',
      ...
      areYouSureYouWantToArchiveThisProject: 'Вы уверены, что хотите архивировать этот проект?',
      ...
      areYouSureYouWantToRestoreThisBoard: 'Вы уверены, что хотите восстановить эту доску?',
      areYouSureYouWantToRestoreThisProject: 'Вы уверены, что хотите восстановить этот проект?',
      ...
      canCompleteTasksChangeLabelsAndComment:
        'Может отмечать задачи, менять метки карточек и писать комментарии.',
      ...
      filterByBoards_title: 'Фильтр по доскам',
      filterByLabels_title: 'Фильтр по меткам',
      filterByMembers_title: 'Фильтр по участникам',
      filterByProjects_title: 'Фильтр по проектам',
      forPersonalProjects: 'Для личных проектов.',
      forTeamBasedProjects: 'Для командных проектов.',
      fromComputer_title: 'С компьютера',
      fromGoogleDrive: 'Из Google Диска',
      googleDrive: 'Google Диск',
      googleDriveIntegration: 'Интеграция с Google Диском',
      googleDriveIntegrationSettings: 'Google Диск',
      googleDriveIntegrationConfigured: 'Интеграция с Google Диском настроена и активна.',
      googleDriveIntegrationNotConfigured: 'Интеграция с Google Диском не настроена.',
      googleDriveIntegrationDisabled: 'Интеграция с Google Диском отключена.',
      ...
      hexColor: 'HEX-цвет',
      googleDriveConnected: 'Google Диск подключён.',
      googleDriveNotConnected: 'Google Диск не подключён.',
      googleDriveConnectRequired: 'Google Диск не подключён. Подключитесь для продолжения.',
      googleDriveConnectionFailed: 'Не удалось подключить Google Диск.',
      googleDrivePickerFailed: 'Не удалось открыть выбор файлов Google Диска.',
      googleDrivePermissionFailed: 'Не удалось изменить доступ к файлу на Google Диске.',
      googleDrivePreviewUnavailable: 'Предпросмотр файла с Google Диска недоступен.',
      openInGoogleDrive: 'Открыть в Google Диске',
      askAdministratorToConfigureGoogleDrive:
        'Обратитесь к администратору для настройки интеграции с Google Диском.',
      onlyFilesCanBeSelected: 'Можно выбирать только файлы.',
      popupWasBlocked:
      ...
      invalidHexColor: 'Введите допустимый цвет #RGB или #RRGGBB.',
      kanban: 'Канбан',
      labels: 'Метки',
      language: 'Язык',
      ...
      moveBoard_title: 'Переместить доску',
      ...
      onlyMyCards: 'Только мои карточки',
      ...
      restoreBoard_title: 'Восстановить доску',
      restoreProject_title: 'Восстановить проект',
      role: 'Роль',
      ...
      fullHdOnly: 'Только Full HD+',
      fullHdPlus: 'Full HD+',
      imageDimensions: '{{width}}×{{height}}',
      imageImportFailed: 'Не удалось импортировать изображение.',
      imageImported: 'Изображение импортировано.',
      imageSearchFailed: 'Не удалось выполнить поиск изображений.',
      imageTooSmall: 'Изображение меньше 1920×1080.',
      imagesBelowFullHdMayLookBad:
        'Изображения более низкого качества могут плохо выглядеть как фон.',
      imagesMayRequireAttribution:
        'Для изображений может требоваться указание авторства. Проверьте лицензию провайдера.',
      importAsBoardBackground: 'Импортировать как фон доски',
      importAsProjectCover: 'Импортировать как обложку проекта',
      importForBoth: 'Импортировать для обоих',
      importFromInternet: 'Импортировать из интернета',
      importingImage: 'Импорт изображения...',
      license: 'Лицензия',
      minimumImageSize: 'Минимум {{width}}×{{height}}',
      noImagesFound: 'Изображения не найдены.',
      onlineImageSearchDisabled: 'Онлайн-поиск изображений не настроен.',
      onlineImages: 'Онлайн-поиск',
      orientation: 'Ориентация',
      orientationAny: 'Любая',
      ...
      afterNOccurrences: 'После {{count}} повторений',
      applyToBoth: 'Применить к обоим',
      clearBackground: 'Очистить фон',
      allDay: 'Весь день',
      calendar: 'Календарь',
      calendarView: 'Вид календаря',
      custom: 'Пользовательское',
      currentCard: 'Только эту карточку',
      tasksCount_one: '{{count}} задача',
      tasksCount_few: '{{count}} задачи',
      tasksCount_many: '{{count}} задач',
      ...
      recurringCard: 'Повторяющаяся карточка',
      recurringCardUpdateEntireSeriesNotice:
        'Перемещение или изменение длительности обновит всю серию.',
      repeatEvery: 'Повторять каждые',
      repeatOn: 'Повторять по',
      schedule: 'Расписание',
      startDate: 'Дата начала',
      startTime: 'Время начала',
      thisRecurringCardUpdateScope: 'Эта карточка повторяется. Что нужно обновить?',
      invalidRecurrenceRule: 'Некорректное правило повторения.',
      week: 'Неделя',
      weekly: 'Еженедельно',
      yearly: 'Ежегодно',
    ...
    action: {
      ...
      duplicateBoard_title: 'Дублировать доску',
      duplicateCard_title: 'Дублировать карточку',
      duplicateList: 'Дублировать список',
      duplicateList_title: 'Дублировать список',
      edit: 'Изменить',
      ...
      restoreBoard: 'Восстановить доску',
      restoreBoard_title: 'Восстановить доску',
      ...
      save: 'Сохранить',
      configureGoogleDrive: 'Настроить Google Диск',
      connectGoogleDrive: 'Подключить Google Диск',
      disconnectGoogleDrive: 'Отключить Google Диск',
      copyRedirectUri: 'Копировать Redirect URI',
      saveGoogleDriveConfiguration: 'Сохранить настройку Google Диска',
      testGoogleDriveConfiguration: 'Тестировать конфигурацию',
      ...
      createCardHere: 'Создать карточку здесь',
