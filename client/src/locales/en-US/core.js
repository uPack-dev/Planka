...
export default {
  ...
  translation: {
    common: {
      ...
      archivedBoard: 'Archived board',
      archivedBoards_title: 'Archived Boards',
      archivedProjects_title: 'Archived Projects',
      ...
      googleDriveIntegrationSettings: 'Google Drive',
      googleDriveIntegrationConfigured: 'Google Drive integration is configured and active.',
      googleDriveIntegrationNotConfigured: 'Google Drive integration is not configured.',
      ...
      googleDriveConnectRequired: 'Google Drive is not connected. Connect to continue.',
      googleDriveConnectionFailed: 'Failed to connect Google Drive.',
      googleDrivePickerFailed: 'Failed to open Google Drive picker.',
      googleDrivePermissionFailed: 'Failed to update Google Drive sharing permissions.',
      googleDrivePreviewUnavailable: 'Google Drive preview is unavailable for this file.',
      openInGoogleDrive: 'Open in Google Drive',
      askAdministratorToConfigureGoogleDrive:
        'Ask an administrator to configure Google Drive integration.',
      ...
      invalidHexColor: 'Enter a valid #RGB or #RRGGBB color.',
      kanban: 'Kanban',
      labels: 'Labels',
      language: 'Language',
      ...
      fullHdOnly: 'Full HD+ only',
      fullHdPlus: 'Full HD+',
      imageDimensions: '{{width}}×{{height}}',
      imageImportFailed: 'Image import failed.',
      imageImported: 'Image imported.',
      imageSearchFailed: 'Image search failed.',
      imageTooSmall: 'Image is smaller than 1920×1080.',
      imagesBelowFullHdMayLookBad: 'Lower-quality images may look bad as backgrounds.',
      imagesMayRequireAttribution: 'Images may require attribution. Check the provider license.',
      importAsBoardBackground: 'Import as board background',
      importAsProjectCover: 'Import as project cover',
      importForBoth: 'Import for both',
      importFromInternet: 'Import from internet',
      importingImage: 'Importing image...',
      license: 'License',
      minimumImageSize: 'Minimum {{width}}×{{height}}',
      noImagesFound: 'No images found.',
      onlineImageSearchDisabled: 'Online image search is not configured.',
      onlineImages: 'Online search',
      ...
      afterNOccurrences: 'After {{count}} occurrences',
      applyToBoth: 'Apply to both',
    ...
    action: {
      ...
      createCardHere: 'Create card here',
      ...
      duplicateList_title: 'Duplicate List',
      edit: 'Edit',
      editAvatar_title: 'Edit Avatar',
      editColor_title: 'Edit Color',
      ...
      saveGoogleDriveConfiguration: 'Save Google Drive Configuration',
      testGoogleDriveConfiguration: 'Test Configuration',
