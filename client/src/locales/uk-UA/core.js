...
export default {
  ...
  translation: {
    common: {
      ...
      archive: 'Архів',
      archiveBoard_title: 'Архівувати дошку',
      archiveCard_title: 'Архівувати картку',
      archiveCards_title: 'Архівувати картки',
      archiveProject_title: 'Архівувати проект',
      archivedBoard: 'Архівна дошка',
      archivedBoards_title: 'Архівні дошки',
      archivedProjects_title: 'Архівні проекти',
      areYouSureYouWantToActivateThisUser: 'Ви впевнені, що хочете активувати цього користувача?',
      areYouSureYouWantToArchiveThisBoard: 'Ви впевнені, що хочете архівувати цю дошку?',
      ...
      areYouSureYouWantToArchiveThisProject: 'Ви впевнені, що хочете архівувати цей проект?',
      ...
      areYouSureYouWantToRestoreThisBoard: 'Ви впевнені, що хочете відновити цю дошку?',
      areYouSureYouWantToRestoreThisProject: 'Ви впевнені, що хочете відновити цей проект?',
      ...
      canCompleteTasksChangeLabelsAndComment:
        'Може відмічати завдання, змінювати мітки карток і писати коментарі.',
      ...
      filterByBoards_title: 'Фільтрувати за дошками',
      filterByLabels_title: 'Фільтрувати за мітками',
      filterByMembers_title: 'Фільтрувати за учасниками',
      filterByProjects_title: 'Фільтрувати за проектами',
      forPersonalProjects: 'Для особистих проектів.',
      forTeamBasedProjects: 'Для командних проектів.',
      fromComputer_title: "З комп'ютера",
      fromGoogleDrive: 'З Google Диска',
      googleDrive: 'Google Диск',
      googleDriveIntegration: 'Інтеграція з Google Диском',
      googleDriveIntegrationSettings: 'Google Диск',
      googleDriveIntegrationConfigured: 'Інтеграцію з Google Диском налаштовано та активовано.',
      googleDriveIntegrationNotConfigured: 'Інтеграцію з Google Диском не налаштовано.',
      googleDriveIntegrationDisabled: 'Інтеграцію з Google Диском вимкнено.',
      googleDriveClientId: 'Client ID',
      googleDriveClientSecret: 'Client Secret',
      googleDrivePickerApiKey: 'Picker API Key',
      googleDrivePickerAppId: 'Picker App ID',
      googleDriveRedirectUri: 'Redirect URI',
      googleDriveScopes: 'Scopes',
      hexColor: 'HEX-колір',
      googleDriveConnected: 'Google Диск підключено.',
      googleDriveNotConnected: 'Google Диск не підключено.',
      googleDriveConnectRequired: 'Google Диск не підключено. Підключіться для продовження.',
      googleDriveConnectionFailed: 'Не вдалося підключити Google Диск.',
      googleDrivePickerFailed: 'Не вдалося відкрити вибір файлів Google Диска.',
      googleDrivePermissionFailed: 'Не вдалося змінити доступ до файлу на Google Диску.',
      googleDrivePreviewUnavailable: 'Попередній перегляд файлу з Google Диска недоступний.',
      openInGoogleDrive: 'Відкрити в Google Диску',
      askAdministratorToConfigureGoogleDrive:
        'Зверніться до адміністратора для налаштування інтеграції з Google Диском.',
      onlyFilesCanBeSelected: 'Можна вибирати лише файли.',
      popupWasBlocked: 'Спливаюче вікно заблоковано. Дозвольте спливаючі вікна для цього сайту.',
      ...
      invalidHexColor: 'Введіть коректний колір #RGB або #RRGGBB.',
      kanban: 'Канбан',
      labels: 'Мітки',
      language: 'Мова',
      ...
      moveBoard_title: 'Перемістити дошку',
      ...
      private: 'Приватний',
      project: 'Проект',
      projectCover: 'Обкладинка проекту',
      ...
      restoreBoard_title: 'Відновити дошку',
      restoreProject_title: 'Відновити проект',
      role: 'Роль',
      ...
      fullHdOnly: 'Лише Full HD+',
      fullHdPlus: 'Full HD+',
      imageDimensions: '{{width}}×{{height}}',
      imageImportFailed: 'Не вдалося імпортувати зображення.',
      imageImported: 'Зображення імпортовано.',
      imageSearchFailed: 'Не вдалося виконати пошук зображень.',
      imageTooSmall: 'Зображення менше за 1920×1080.',
      imagesBelowFullHdMayLookBad: 'Зображення нижчої якості можуть погано виглядати як фон.',
      imagesMayRequireAttribution:
        'Для зображень може бути потрібне зазначення авторства. Перевірте ліцензію провайдера.',
      importAsBoardBackground: 'Імпортувати як фон дошки',
      importAsProjectCover: 'Імпортувати як обкладинку проекту',
      importForBoth: 'Імпортувати для обох',
      importFromInternet: 'Імпортувати з інтернету',
      importingImage: 'Імпорт зображення...',
      license: 'Ліцензія',
      minimumImageSize: 'Мінімум {{width}}×{{height}}',
      noImagesFound: 'Зображення не знайдено.',
      onlineImageSearchDisabled: 'Онлайн-пошук зображень не налаштовано.',
      onlineImages: 'Онлайн-пошук',
      orientation: 'Орієнтація',
      orientationAny: 'Будь-яка',
      ...
      provider: 'Провайдер',
      providerAuto: 'Авто',
      providerNotConfigured: 'не налаштовано',
      providerOpenverse: 'Openverse',
      providerPexels: 'Pexels',
      providerUnsplash: 'Unsplash',
      providerWikimedia: 'Wikimedia Commons',
      searchOnlineImages: 'Шукати',
      ...
      afterNOccurrences: 'Після {{count}} повторень',
      applyToBoth: 'Застосувати до обох',
      clearBackground: 'Очистити фон',
      allDay: 'Увесь день',
      calendar: 'Календар',
      calendarView: 'Вигляд календаря',
      custom: 'Користувацьке',
      currentCard: 'Лише цю картку',
      tasksCount_one: '{{count}} завдання',
      tasksCount_few: '{{count}} завдання',
      tasksCount_many: '{{count}} завдань',
      tasksCount_other: '{{count}} завдання',
      daily: 'Щодня',
      day: 'День',
      endDate: 'Дата завершення',
      endTime: 'Час завершення',
      ends: 'Завершення',
      entireSeries: 'Усю серію',
      month: 'Місяць',
      monthly: 'Щомісяця',
      never: 'Ніколи',
      noRecurrence: 'Без повторення',
      onDate: 'У дату',
      recurrence: 'Повторення',
      recurringCard: 'Повторювана картка',
      recurringCardUpdateEntireSeriesNotice: 'Переміщення або зміна тривалості оновить усю серію.',
      repeatEvery: 'Повторювати кожні',
      repeatOn: 'Повторювати у',
      schedule: 'Розклад',
      startDate: 'Дата початку',
      startTime: 'Час початку',
      thisRecurringCardUpdateScope: 'Ця картка повторюється. Що потрібно оновити?',
      invalidRecurrenceRule: 'Некоректне правило повторення.',
      week: 'Тиждень',
      weekly: 'Щотижня',
      yearly: 'Щороку',
    ...
    action: {
      ...
      archive: 'Архівувати',
      archiveBoard: 'Архівувати дошку',
      archiveBoard_title: 'Архівувати дошку',
      archiveCard: 'Архівувати картку',
      archiveCard_title: 'Архівувати картку',
      archiveCards: 'Архівувати картки',
      archiveCards_title: 'Архівувати картки',
      archiveProject: 'Архівувати проект',
      archiveProject_title: 'Архівувати проект',
      ...
      duplicateBoard: 'Дублювати дошку',
      duplicateBoard_title: 'Дублювати дошку',
      duplicateCard_title: 'Дублювати картку',
      duplicateList: 'Дублювати список',
      duplicateList_title: 'Дублювати список',
      edit: 'Редагувати',
      editAvatar_title: 'Редагувати аватар',
      editColor_title: 'Редагувати колір',
      ...
      restoreBoard: 'Відновити дошку',
      restoreBoard_title: 'Відновити дошку',
      restoreProject: 'Відновити проект',
      restoreProject_title: 'Відновити проект',
      remove: 'Видалити',
      ...
      save: 'Зберегти',
      configureGoogleDrive: 'Налаштувати Google Диск',
      connectGoogleDrive: 'Підключити Google Диск',
      disconnectGoogleDrive: 'Відключити Google Диск',
      copyRedirectUri: 'Копіювати Redirect URI',
      saveGoogleDriveConfiguration: 'Зберегти налаштування Google Диска',
      testGoogleDriveConfiguration: 'Тестувати конфігурацію',
      ...
      clearSchedule: 'Очистити розклад',
      createCardHere: 'Створити картку тут',
